...
def resize_to_target_area(width_mm, height_mm, target_area=5000):
    """
    ...
    Args:
        ...
        target_area: Target surface area in square millimeters (default 5000)
...
def main():
    ...
    try:
        ...
        new_width, new_height = resize_to_target_area(width, height, target_area=5000)
